...
id: profil
title: Profil
description: Unternehmens- und Benutzereinstellungen verwalten
type: reference
platform: web
sidebar_position: 1
searchTerms:
...
Hier konfigurieren Sie die grundlegenden Unternehmensdaten:
...
Hier verwalten Sie die Verbindung zum Finanzamt für die Registrierkassenpflicht (in Österreich).
...
**Gutscheinkonto:**
- Konto für Mehrzweckgutscheine

:::warning
Alle Felder müssen ausgefüllt sein, damit der Export funktioniert.
:::
