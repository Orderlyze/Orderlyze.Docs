---
id: funktionen-rechnungen-bearbeiten
title: Rechnungen nachträglich bearbeiten/stornieren
description: Zahlungsart einer bereits abgeschlossenen Rechnung ändern oder eine Rechnung stornieren
type: tutorial
platform: app
sidebar_position: 7
searchTerms:
...
# Rechnungen nachträglich bearbeiten / stornieren

Bereits abgeschlossene Rechnungen lassen sich in der Rechnungsübersicht nachträglich anpassen — entweder durch Änderung der Zahlungsart oder durch Storno.

:::info Voraussetzungen
Beide Funktionen müssen unter **Weitere Einstellungen** aktiviert sein:

- **Stornierung in Rechnungsübersicht**
- **Bearbeitung Zahlungsoptionen vergangener Rechnungen**
:::

---

## Zahlungsart einer vergangenen Rechnung ändern

1. Oben links auf das **Menü-Symbol** tippen
2. **Rechnungsübersicht** öffnen
