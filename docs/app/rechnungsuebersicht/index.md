---
id: app-rechnungsuebersicht
title: Rechnungsübersicht
description: Abgeschlossene Rechnungen ansehen, filtern und nachdrucken
type: reference
platform: app
sidebar_position: 5
searchTerms:
...
<div className="device-gallery">
  <figure className="device-figure">
    <img src="/screenshots/app/05_invoice_overview.png" alt="Rechnungsübersicht (Handy)" width="220" />
...
<div className="device-gallery">
  <figure className="device-figure">
    <img src="/screenshots/app/35_rechnungsuebersicht.png" alt="Rechnungsdetail (Handy)" width="220" />
    <figcaption>Handy</figcaption>
  </figure>
  <figure className="device-figure">
...
**Navigation:** Rechnungsübersicht → Auf eine Rechnung tippen
